...
await p.screenshot({path:SHOT+'23-plan-a.png'});
for(let i=1;i<=4;i++){ await p.mouse.wheel(0,700); await p.waitForTimeout(700); await p.screenshot({path:SHOT+'23-plan-'+i+'.png'}); }
