...
**ZONA DE EMERGENCIA pisa al semáforo.** Si la ciudad o región de un festival
está bajo una situación excepcional activa (sismo, inundación, orden público),
ese festival se revisa **a diario sin importar su color**, buscando lenguaje de
traslado / aplazamiento / cancelación. El semáforo por fecha no sabe de
terremotos: QAFF estaba AMARILLO a 25 días cuando anunció el traslado de toda
su edición a Bogotá, y FICMA ya había enseñado lo mismo con su aplazamiento.
...
Y su caso peor no es el bloqueo sino el **contenido viejo que carga**: un perfil
activo sin posts recientes visibles es carga incompleta, no silencio — se
reintenta o queda como vistazo pendiente, nunca como «sin novedades».

## Instagram va EN EL NAVEGADOR — nunca por fetch de texto

Regla invertida el 23 ago 2026, con cicatriz: el 20 ago QAFF publicó como POST
de IG el comunicado que trasladaba **todas** sus proyecciones a Bogotá por el
sismo del Chocó, y el radar reportó silencio durante tres días. El WebFetch de
texto sobre Instagram devuelve la bio y contenido viejo que **parece** legible:
un falso negativo, que a diferencia del bloqueo no dispara ninguna alarma.

Por eso IG se lee en el navegador (Claude Browser), siempre: la **bio**, los
**2–3 posts más recientes del grid abiertos** (los anuncios graves —traslados,
aplazamientos, comunicados— viven en los posts, no en la bio) y el **avatar**
