...
PUENTE = {
 ...
 # OJO al orden: la ficha del PDF la titula «ANGELA DAVIS & GERTY ARCHIMÈDE».
 # Aquí decía «ARCHIMÈDE GERTY», con el apellido y el nombre cambiados, así que
 # el cruce fallaba en silencio y la obra se quedó sin sinopsis teniéndola en la
 # p21. Un puente con el nombre mal escrito no da error: no encuentra y calla.
 'SISTERS IN DESTINY: ANGELA DAVIS & GERTY ARCHIMEDE': 'ANGELA DAVIS & GERTY ARCHIMÈDE',
 'HERMANAS EN EL DESTINO - ANGELA & GERTY ARCHIMÈDE': 'ANGELA DAVIS & GERTY ARCHIMÈDE',
