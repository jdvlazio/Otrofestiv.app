...
export const _I18N = {
  es: {
    ...
    "plan_empty_dia": "No hay actividades para este día. Agregá desde Sugerencias o recalculá en Planear.",
    ...
    "aviso_prog_cortos": "Verás los otros cortos",
    "aviso_prog_obras": "Verás las otras obras",
    "toast_prog_uno": "+1 corto del mismo programa",
    "toast_prog_n": "+{n} cortos del mismo programa",
    "toast_prog_juntos": "van juntos en una sola función",
  ...
  en: {
    ...
    "plan_empty_dia": "No activities for this day. Add from Suggestions or recalculate in Planner.",
    ...
    "aviso_prog_cortos": "You'll see the other shorts",
    "aviso_prog_obras": "You'll see the other films",
    "toast_prog_uno": "+1 short from the same program",
    "toast_prog_n": "+{n} shorts from the same program",
    "toast_prog_juntos": "they go together in a single screening",
  ...
  pt: {
    ...
    "plan_empty_dia": "Não há sessões para este dia. Adicione em Sugestões ou recalcule em Planejar.",
    ...
    "aviso_prog_cortos": "Você verá os outros curtas",
    "aviso_prog_obras": "Você verá as outras obras",
