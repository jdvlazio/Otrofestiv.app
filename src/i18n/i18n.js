...
export const _I18N = {
  es: {
    ...
    "cuenta_viaje": "{t1} termina {end}. Viaje ~{travel} → llegarías {arr}.",
    "cuenta_viaje_qa": "{t1} termina {end} + Q&A ~{qa} min → {qaEnd}. Viaje ~{travel} → llegarías {arr}.",
    "cuenta_no_llegas": "La función es a las {start}: no te daría el tiempo.",
    "cuenta_al_filo": "La función es a las {start}: te quedarían {m} min.",
  ...
  en: {
    ...
    "cuenta_viaje": "{t1} ends {end}. Travel ~{travel} → you'd arrive {arr}.",
    "cuenta_viaje_qa": "{t1} ends {end} + Q&A ~{qa} min → {qaEnd}. Travel ~{travel} → you'd arrive {arr}.",
    "cuenta_no_llegas": "The screening is at {start}: you likely wouldn't make it.",
    "cuenta_al_filo": "The screening is at {start}: you'd have {m} min.",
