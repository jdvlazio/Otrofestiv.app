...
export const _I18N = {
  es: {
    ...
    "plan_empty_dia": "No hay actividades para este día. Añadí desde Sugerencias.",
    ...
    "plan_delay_warn_critico": "Con el retraso terminas ~{end}. Solo quedan {min} min antes de {film}{travel}",
    "plan_delay_travel": " ({n} min de viaje)",
    "plan_delay_warn_ajustado": "Terminas ~{end}. Margen ajustado: {margin} min hasta {film}.",
    ...
    "plan_reemplazar_funcion_body": "Quitar {old} y añadir {new} al plan.",
    "plan_anadir_plan_body": "Añadir {new} al plan.",
    ...
    "recap_marca_sub": "Marcá lo que viste y calificalo.",
    ...
    "ics_permission_denied": "Permite el acceso en Ajustes > Privacidad > Calendarios",
