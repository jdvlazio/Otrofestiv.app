...
try:
    ...
    _ALLOW = {
        ...
        'src/controller/sheets-controller.js': 1799,  # +14: countryToFlags normaliza (una mayúscula no puede costar un globo) + 14 países que salían como 🌍 en festivales VIVOS — 4 sep  # antes 1783,
