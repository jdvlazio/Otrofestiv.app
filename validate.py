...
try:
    ...
    _ALLOW = {
        ...
        'src/controller/sheets-controller.js': 1495,  # +39: la ficha de corto hereda la función de su(s) programa(s) — _screeningRows (dueño único, antes inline en openPelSheet), _findParentPrograms, _cortoScreeningPairs y _noticeRows (dueño único del aviso cancelada/reprogramada, heredado por título de programa) (29 jul 2026)
