...
try:
    ...
    _ALLOW = {
        ...
        'src/view/components.js': 873,  # +58: makeSharedSlotSVG — el póster de función compartida (Escalera mayor §6.0) — 21 ago  # +7: «foro» y «debate» entran al vocabulario (Cinemancia 2026) — 21 ago
