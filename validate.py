...
try:
    ...
    _ALLOW = {
        ...
        'src/config.js': 951,  # +25: QAFF 2026 (entrada de FESTIVAL_CONFIG) — 23 ago  # +1: el afiche oficial de «Los bibliotecarios» — 23 ago  # +78: PALMARES de FICDEH 2026 (19 entradas + el porqué de tres correcciones sobre la fuente) — 23 ago  # +40: TIFF 2026 (entrada + 13 arquetipos de sección) — 23 ago
